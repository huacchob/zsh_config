                    ...
                    init_options = {
                        settings = {
                            args = {
                                ...
                                "--unsafe-fixes",                -- apply aggressive auto-fixes
                                "--line-length=88",              -- enforce Black-style formatting
                                "--extend-select=I,B,C4,IC,PIE,PLC,PLE,PLR,PLW,NPY,TRY", -- extra rule sets
                                "--preview",                     -- enable upcoming features
                                "--respect-gitignore",

                                -- Linting severity upgrades (optional)
                                "--exit-zero", -- make linting non-blocking (can remove if using for CI)
                            },
                        },
                    },
